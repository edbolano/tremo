 ...
 */
public class PanelMarcosZ extends JPanel{
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(  (columna==0)||(columna==1)||(columna==2)||(columna==3)  ){
                    if(TITULOS[columna].compareTo(posiciones[columna])==0){
                        switch (columna){
                            case 0://marco id
                                if( (Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila]!=null)
                                &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador().compareTo("Marco no definido")!=0) ){
                                    int opcion = JOptionPane.showConfirmDialog(null,"La rigidez del marco: " +
                                            "\n"+Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador()
                                            +"  es : "+Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getRigidezR()
                                            +" Ton/cm" +
                                            "\n\nDesea asignar la rigidez de este marco manualmente?","PREGUNTA",JOptionPane.YES_NO_OPTION);
                                    if(opcion==JOptionPane.YES_OPTION){
                                        Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].setRigidezDesignadaManualmente(true);
                                        ...
                                        Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].setRigidezDesignadaManualmente(false);
                                    }
                                }
                                break;
                            case 1://columnasN
    ...
    private ActionListener accionCrearMarcos(){
        ActionListener retorno = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int indiceLimpio = 0;
                for(int i=0;i<512;i++){
                    if((arrLocalMarcosZ[i]!=null)
                    &&(arrLocalMarcosZ[i].getIdentificador().compareTo("Marco no definido")!=0)
                    &&(arrLocalMarcosZ[i].calcularAlturaN()!=0)){
                        Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[indiceLimpio] = arrLocalMarcosZ[i];
                        indiceLimpio++;
                    }
                }
                    ...
                    if( tablaMarcos.getValueAt(filas,0).toString().compareTo("")!=0 ){
                        ...
                        try{
                            ...
                            JOptionPane.showMessageDialog(null,"Formato erroneo, revisar casilla de altura inferior"
                                    +"\nen "+Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getIdentificador()+
                        ...
                        Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].setAlturaM(altM );
                        Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].setAlturaO(altO );
                        ...
                        ||(!Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].isRigidezDesignadaManualmente()) ){
                            float rigid = Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].calcularRigidez();
                            Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].setRigidezR(rigid);
                        } else {
                            float rig = Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].calcularRigidez();
                            try{
                            ...
                            Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].setRigidezR(rig);
                        }
...
//                                +Main.getArchivoDeTrabajo().getMarcosDeArchivoEnX()[filas].getRigidezR());
    ...
    public void llenarTablaMarcos(){
        ...
        for(int filas=0;filas<512;filas++){
            for(int cols=0;cols<7;cols++){
                if( (Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas]!=null) 
                  &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getIdentificador().compareTo("Marco no definido")!=0)  ){
                    switch(cols){
                        case 0://id marco
                        {
                            tablaMarcos.setValueAt(
                                    Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getIdentificador(),
                                    filas,0);
                        }//break;
                        case 1://columnas n
                        {
...
//                            columnasDeTabla[1].setCellEditor(new DefaultCellEditor(combo) );
                        ...
                        case 4://hm altura entre pisoinferior
                        {
                            tablaMarcos.setValueAt( String.valueOf(
                                    Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getAlturaM()  
                                                   ),
                                    filas,4);
                        }
                        ...
                        {
                            tablaMarcos.setValueAt( String.valueOf(
                                    Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getAlturaO()
                                                   ),
                                    filas,5);
                        }
                        case 6://Rigidez opcional
                        {
                            if(  Float.isNaN(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getRigidezR())  ){
                                tablaMarcos.setValueAt(
                                                "Asignar_opcionalmente",
                                                filas,6);
                            }else{
                                tablaMarcos.setValueAt( String.valueOf(
                                    Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas].getRigidezR()
                                                   ),
                                    filas,6);
                            }
                        }
    ...
    private void informacionColumnasN(int fila, int col){
        ...
        if( (Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila]!=null)
        &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador().compareTo("Marco no definido")!=0) ){
            nombreMarco = Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador();
            for(int i=0;i<512;i++){
                if( (Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getColumnasN()[i]!=null)
                &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getColumnasN()[i].getIdentificador().compareTo("elemento sin nombre")!=0) ){
                    mensajeTemp = mensajeTemp +"\n"+ 
                            Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getColumnasN()[i].getIdentificador();
                }
            }
        }
    ...
    private void informacionVigasM(int fila, int col){
        ...
        &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador().compareTo("Marco no definido")!=0) ){
            nombreMarco = Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador();
            for(int i=0;i<512;i++){
                if( (Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getVigasM()[i]!=null)
                &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getVigasM()[i].getIdentificador().compareTo("elemento sin nombre")!=0) ){
                    mensajeTemp = mensajeTemp +"\n"+ 
                            Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getVigasM()[i].getIdentificador();
                }
            }
        }
    ...
    private void informacionVigasN(int fila, int col){
        ...
        &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador().compareTo("Marco no definido")!=0) ){
            nombreMarco = Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getIdentificador();
            for(int i=0;i<512;i++){
                if( (Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getVigasN()[i]!=null)
                &&(Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getVigasN()[i].getIdentificador().compareTo("elemento sin nombre")!=0) ){
                    mensajeTemp = mensajeTemp +"\n"+ 
                            Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[fila].getVigasN()[i].getIdentificador();
                }
            }
        }
                ...
                if(opcion == 0){   //Si el usuario pulsa SI
                    for(int filas = 0;filas<512;filas++){
                        for(int cols =0;cols<7;cols++){
                            ...
                            Main.getArchivoDeTrabajo().getMarcosDeArchivoEnZ()[filas] = new MarcoZ();
                        }
                    }
