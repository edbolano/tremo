/*
 * EscuchaAccionRegenerar3D.java
 *
 * Created on 5 de diciembre de 2006, 05:56 PM
 *
 ...
 */
public class EscuchaAccionRegenerar3D implements ActionListener {
    
    /** Creates a new instance of EscuchaAccionRegenerar3D */
    public EscuchaAccionRegenerar3D() {
    }

    public void actionPerformed(ActionEvent e) {
        Main.getAplicacion().dispose();
        Main.getAplicacion().setVisible(false);
//        Main.getAplicacion().getUnPanelDeFichas().getPanelVistaUno().dispose();
        Main.setAplicacion(new VentanaPrincipal() );
        construirEscena();
    }
